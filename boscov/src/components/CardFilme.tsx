            ...
            <div className="bg-neutral-900 rounded-xl shadow-lg border border-neutral-800 flex flex-col items-center p-4 transition hover:scale-[1.02] hover:border-gray-600 w-full max-w-xs mx-auto h-full">
                ...
                <div className="flex gap-2 w-full mt-auto">
                    <button
                        ...
                        className="flex-1 flex items-center justify-center gap-2 px-3 py-2 sm:px-2 sm:py-1 rounded bg-neutral-800 hover:bg-neutral-700 text-gray-200 font-medium transition text-base sm:text-sm cursor-pointer"
                    >
                        <FiEdit />
                        Avaliar
                    </button>
